...
/datum/subsystem/air
	...
	var/obj/effect/overlay/fart_overlay				//overlay for fart
...
/datum/subsystem/air/New()
	...
	fart_overlay	= new /obj/effect/overlay{icon='icons/effects/tile_effects.dmi';mouse_opacity=0;layer=5;icon_state="fart"}()

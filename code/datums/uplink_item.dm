...
/datum/uplink_item/job_specific/HumanPokeball
	...
	desc = "This device, when thrown, will rapidly apply a blindfold, muzzle and straight jacket to a target, it will remove clothing where necessary unless that clothing cannot normally be removed. They will also be very briefly knocked down."

//TODO: Fix the animation for heat
...
/obj/machinery/atmospherics/pipe/simple/heat_exchanging/process()
	...
	if(buckled_mob)
		...
		if(pipe_air.temperature > heat_limit + 1)
			buckled_mob.apply_damage(4 * log(pipe_air.temperature - heat_limit), BURN)

	//Heat causes pipe to glow - Currently broken, need to figure out why.

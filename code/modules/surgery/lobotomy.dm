/datum/surgery/lobotomy //this is so fucked up who the fuck let people do this in real life
	name = "lobotomy"
	steps = list(/datum/surgery_step/incise, /datum/surgery_step/clamp_bleeders, /datum/surgery_step/retract_skin, /datum/surgery_step/lobotomize)
	species = list(/mob/living/carbon/human, /mob/living/carbon/monkey)
	possible_locs = list("eyes")

/datum/surgery_step/lobotomize
	implements = list(/obj/item/weapon/screwdriver = 100, /obj/item/weapon/screwdriver = 75, /obj/item/weapon/kitchen/fork = 50, /obj/item/weapon/pen = 25) //variety is the spice of life my friend
	time = 64

/mob/living/carbon/human/proc/plasma_fist_help()
	...
	usr << "<span class='notice'><B>THE ULTIMATE PLASMA FIST TECHNIQUE! Grab, Harm, Disarm, Harm, Disarm, Grab, Harm (GHDHDGH)</span>"

#define TORNADO_COMBO "HHD"
#define THROWBACK_COMBO "DHD"
#define KNOCKOUT_COMBO "GGH"
#define PLASMA_COMBO "GHDHDGH"
...
/datum/martial_art/plasma_fist/teach(var/mob/living/carbon/human/H)
	..()
...
/datum/martial_art/plasma_fist/proc/Tornado(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
	...
	spawn(0)
		for(var/i in list(NORTH,SOUTH,EAST,WEST,EAST,SOUTH,NORTH,SOUTH,EAST,WEST,EAST,SOUTH))
			A.dir = i
			playsound(A.loc, 'sound/weapons/punch1.ogg', 15, 1, -7)
			sleep(1)
...
/datum/martial_art/plasma_fist/proc/Throwback(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
	...
	playsound(D.loc, 'sound/weapons/punch1.ogg', 50, 1, -7)
...
/datum/martial_art/plasma_fist/harm_act(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
	...
	A.changeNext_move(2) //Allows you to combo the FUCK out
	return 1

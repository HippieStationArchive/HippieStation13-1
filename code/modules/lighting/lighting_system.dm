...
/datum/light_source/New(atom/A)
	...
	__x = owner.x
	__y = owner.y
	lighting_controller.changed_lights |= src
...
//Objects with opacity will trigger nearby lights to update at next lighting_controller fire
...
//Objects with opacity will trigger nearby lights of the old location to update at next lighting_controller fire
...
/turf/ChangeTurf(var/path)
	...
	lighting_changed = 1 //Don't add ourself to lighting_controller.changed_turfs

...
#define THERMAL_RELEASE_MODIFIER 50		//Higher == more heat released during reaction
#define PLASMA_RELEASE_MODIFIER 500		//Higher == less plasma released by reaction

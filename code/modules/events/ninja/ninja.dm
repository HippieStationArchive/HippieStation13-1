...
/*
Cleanup crew here, reminding everyone that having an entire module for one event
and 21 files for a single suit is not making the code "less snowflakey" -QC
*/

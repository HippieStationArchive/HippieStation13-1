...
/mob/living/carbon/proc/check_breath(datum/gas_mixture/breath)
	...
	if(O2_partialpressure < safe_oxy_min) //Not enough oxygen
		...
		if(O2_partialpressure > 0)
			...
			failed_last_breath = 1
			oxygen_used = breath.gases["o2"][MOLES]*ratio/6
		else
			adjustOxyLoss(3)
			failed_last_breath = 1
		throw_alert("oxy", /obj/screen/alert/oxy)
		...
		adjustOxyLoss(-5)
		oxygen_used = breath.gases["o2"][MOLES]/6
		clear_alert("oxy")

	breath.gases["o2"][MOLES] -= oxygen_used
	breath.gases["co2"][MOLES] += oxygen_used
	...
	if(Toxins_partialpressure > safe_tox_max)
		var/ratio = (breath.gases["plasma"][MOLES]/safe_tox_max) * 10
		if(reagents)
	...
	//NITROUS OXIDE
	if(breath.gases["n2o"])
		var/SA_partialpressure = (breath.gases["n2o"][MOLES]/breath.total_moles())*breath_pressure

...
/mob/living/simple_animal/hostile/timelost_spellcaster
...
/mob/living/simple_animal/hostile/timelost_spellcaster/ex_act(severity)
	return 0 //bombs? ha. Also used to make sure he can't hurt himself with timebomb.

/mob/living/simple_animal/hostile/timelost_spellcaster/New()
	..()
...
/mob/living/simple_animal/hostile/timelost_spellcaster/death()
...
/mob/living/simple_animal/hostile/timelost_spellcaster/handle_automated_action()
	. = ..()
...
/mob/living/simple_animal/hostile/timelost_reflection
...
/mob/living/simple_animal/hostile/timelost_reflection/ex_act(severity)
	return 0 //so that they don't get blown up by timebombs

/mob/living/simple_animal/hostile/timelost_reflection/death()
	qdel(src)
...
/mob/living/simple_animal/hostile/timelost_spellcaster_multiverse_phase
	name = "timelost spellcaster"
...
/mob/living/simple_animal/hostile/timelost_spellcaster_multiverse_phase/ex_act(severity)
	return 0 //still no cheese

/mob/living/simple_animal/hostile/timelost_spellcaster_multiverse_phase/New()
	..()
...
/mob/living/simple_animal/hostile/timelost_spellcaster_multiverse_phase/handle_automated_action()
	. = ..()
	if(target && next_cast < world.time)
...
/mob/living/simple_animal/hostile/timelost_spellcaster_multiverse_phase/death()
...
/obj/effect/timelost_transition/New()
	spawn(70)
		new /mob/living/simple_animal/hostile/timelost_spellcaster_final_phase(src.loc)
		qdel(src)


/mob/living/simple_animal/hostile/timelost_multiverse //the mook that the second phase boss will use
...
/mob/living/simple_animal/hostile/timelost_multiverse/ex_act(severity)
	return 0 //so that phase3 doesn't blow him up

/mob/living/simple_animal/hostile/timelost_multiverse/New()
	..()
	bladedash = new /obj/effect/proc_holder/spell/self/bladedash
	bladedash.human_req = 0
	bladedash.player_lock = 0
...
/mob/living/simple_animal/hostile/timelost_multiverse/death()
	qdel(src)

/mob/living/simple_animal/hostile/timelost_illusion
	name = "timelost spellcaster"
	desc = "Clearly a fake."
	icon_state = "2lost_spellcaster"
...
/mob/living/simple_animal/hostile/timelost_spellcaster_final_phase
	name = "timelost spellcaster"
...
/mob/living/simple_animal/hostile/timelost_spellcaster_final_phase/New()
	..()
	repulse = new /obj/effect/proc_holder/spell/aoe_turf/repulse
	repulse.clothes_req = 0
	repulse.human_req = 0
...
/mob/living/simple_animal/hostile/timelost_spellcaster_final_phase/death()
	visible_message("<span class='userdanger'><font color ='red'>[src] is erased from time itself!</span>")
	qdel(src)

/mob/living/simple_animal/hostile/timelost_spellcaster_final_phase/handle_automated_action()
	. = ..()
	if(target && next_cast < world.time)
		if(timebomb.cast_check(0,src))
			timebomb.choose_targets(src)

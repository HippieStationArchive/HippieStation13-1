...
/datum/preferences/proc/update_preview_icon()		//seriously. This is horrendous.
	...
	if(job_civilian_low & ASSISTANT)//This gives the preview icon clothes depending on which job(if any) is set to 'high'
		...
		switch(backbag)
			if(1) clothes_s.Blend(new /icon('icons/mob/back.dmi', "backpack"), ICON_OVERLAY)
			if(2) clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel-norm"), ICON_OVERLAY)
			if(3) clothes_s.Blend(new /icon('icons/mob/back.dmi', "duffle"), ICON_OVERLAY)
			if(4) clothes_s.Blend(new /icon('icons/mob/back.dmi', "mountainbag"), ICON_OVERLAY)
		...
		switch(job_civilian_high)
			...
			if(BOTANIST)
				...
				switch(backbag)
					if(1) clothes_s.Blend(new /icon('icons/mob/back.dmi', "botpack"), ICON_OVERLAY)
					if(2) clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel-hyd"), ICON_OVERLAY)
					if(3) clothes_s.Blend(new /icon('icons/mob/back.dmi', "duffle-hydroponics"), ICON_OVERLAY)
					if(4) clothes_s.Blend(new /icon('icons/mob/back.dmi', "mountainbag-hyd"), ICON_OVERLAY)
			if(CHEF)
			...
			if(MINER)
				...
				clothes_s.Blend(new /icon('icons/mob/feet.dmi', "black"), ICON_OVERLAY)
				switch(backbag)
					if(1) clothes_s.Blend(new /icon('icons/mob/back.dmi', "engiepack"), ICON_OVERLAY)
					if(2) clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel-eng"), ICON_OVERLAY)
					if(3) clothes_s.Blend(new /icon('icons/mob/back.dmi', "duffle-eng"), ICON_OVERLAY)
					if(4) clothes_s.Blend(new /icon('icons/mob/back.dmi', "mountainbag"), ICON_OVERLAY)
			if(LAWYER)
			...
			if(CLOWN)
				...
				switch(backbag)
					if(1) clothes_s.Blend(new /icon('icons/mob/back.dmi', "clownpack"), ICON_OVERLAY)
					if(2) clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel-norm"), ICON_OVERLAY)
					if(3) clothes_s.Blend(new /icon('icons/mob/back.dmi', "duffle-clown"), ICON_OVERLAY)
					if(4) clothes_s.Blend(new /icon('icons/mob/back.dmi', "mountainbag"), ICON_OVERLAY)
			if(MIME)
				...
				switch(backbag)
					if(1) clothes_s.Blend(new /icon('icons/mob/back.dmi', "mimepack"), ICON_OVERLAY)
					if(2) clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel-norm"), ICON_OVERLAY)
					if(3) clothes_s.Blend(new /icon('icons/mob/back.dmi', "duffle"), ICON_OVERLAY)
					if(4) clothes_s.Blend(new /icon('icons/mob/back.dmi', "mountainbag"), ICON_OVERLAY)
		...
		switch(job_medsci_high)
			if(RD)
				...
				switch(backbag)
					if(1) clothes_s.Blend(new /icon('icons/mob/back.dmi', "backpack"), ICON_OVERLAY)
					if(2) clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel-tox"), ICON_OVERLAY)
					if(3) clothes_s.Blend(new /icon('icons/mob/back.dmi', "duffle-toxins"), ICON_OVERLAY)
					if(4) clothes_s.Blend(new /icon('icons/mob/back.dmi', "mountainbag-tox"), ICON_OVERLAY)
			if(SCIENTIST)
			...
			if(CHEMIST)
				...
				switch(backbag)
					if(1) clothes_s.Blend(new /icon('icons/mob/back.dmi', "backpack"), ICON_OVERLAY)
					if(2) clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel-chem"), ICON_OVERLAY)
					if(3) clothes_s.Blend(new /icon('icons/mob/back.dmi', "duffle-chemistry"), ICON_OVERLAY)
					if(4) clothes_s.Blend(new /icon('icons/mob/back.dmi', "mountainbag-chem"), ICON_OVERLAY)
			if(CMO)
				...
				switch(backbag)
					if(1) clothes_s.Blend(new /icon('icons/mob/back.dmi', "medicalpack"), ICON_OVERLAY)
					if(2) clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel-med"), ICON_OVERLAY)
					if(3) clothes_s.Blend(new /icon('icons/mob/back.dmi', "duffle-med"), ICON_OVERLAY)
					if(4) clothes_s.Blend(new /icon('icons/mob/back.dmi', "mountainbag-med"), ICON_OVERLAY)
			if(DOCTOR)
			...
			if(GENETICIST)
				...
				switch(backbag)
					if(1) clothes_s.Blend(new /icon('icons/mob/back.dmi', "genepack"), ICON_OVERLAY)
					if(2) clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel-gen"), ICON_OVERLAY)
					if(3) clothes_s.Blend(new /icon('icons/mob/back.dmi', "duffle-genetics"), ICON_OVERLAY)
					if(4) clothes_s.Blend(new /icon('icons/mob/back.dmi', "mountainbag-gen"), ICON_OVERLAY)
			if(VIROLOGIST)
				...
				switch(backbag)
					if(1) clothes_s.Blend(new /icon('icons/mob/back.dmi', "viropack"), ICON_OVERLAY)
					if(2) clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel-vir"), ICON_OVERLAY)
					if(3) clothes_s.Blend(new /icon('icons/mob/back.dmi', "duffle-virology"), ICON_OVERLAY)
					if(4) clothes_s.Blend(new /icon('icons/mob/back.dmi', "mountainbag-vir"), ICON_OVERLAY)
			if(ROBOTICIST)
		...
		switch(job_engsec_high)
			if(CAPTAIN)
				...
				switch(backbag)
					if(1) clothes_s.Blend(new /icon('icons/mob/back.dmi', "captainpack"), ICON_OVERLAY)
					if(2) clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel-cap"), ICON_OVERLAY)
					if(3) clothes_s.Blend(new /icon('icons/mob/back.dmi', "duffle-captain"), ICON_OVERLAY)
					if(4) clothes_s.Blend(new /icon('icons/mob/back.dmi', "mountainbag"), ICON_OVERLAY)
			if(HOS)
				...
				switch(backbag)
					if(1) clothes_s.Blend(new /icon('icons/mob/back.dmi', "securitypack"), ICON_OVERLAY)
					if(2) clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel-sec"), ICON_OVERLAY)
					if(3) clothes_s.Blend(new /icon('icons/mob/back.dmi', "duffle-sec"), ICON_OVERLAY)
					if(4) clothes_s.Blend(new /icon('icons/mob/back.dmi', "mountainbag"), ICON_OVERLAY)
			if(WARDEN)

...
/obj/item/clothing/under/rank/security
	...
	item_state = "r_suit"
	item_color = "security"
	armor = list(melee = 20, bullet = 0, laser = 0,energy = 0, bomb = 0, bio = 0, rad = 0) // Exact same protection on the chest after changing to multiplicative stacking when wearing a security vest.
	strip_delay = 50
	alt_covers_chest = 1

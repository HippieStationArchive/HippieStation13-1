...
/obj/item/clothing/shoes
	...
	var/list/bloody_shoes = list(BLOOD_STATE_HUMAN = 0,BLOOD_STATE_XENO = 0, BLOOD_STATE_OIL = 0, BLOOD_STATE_NOT_BLOODY = 0, BLOOD_STATE_POOP = 0)
...
/obj/item/clothing/shoes/worn_overlays(var/isinhands = FALSE)
	...
	if(!isinhands)
		...
		if(blood_state == BLOOD_STATE_POOP)
			. += image("icon"='icons/effects/blood.dmi', "icon_state"="shoop")

/obj/item/clothing/shoes/clean_blood()
	..()
	bloody_shoes = list(BLOOD_STATE_HUMAN = 0,BLOOD_STATE_XENO = 0, BLOOD_STATE_OIL = 0, BLOOD_STATE_NOT_BLOODY = 0, BLOOD_STATE_POOP = 0)

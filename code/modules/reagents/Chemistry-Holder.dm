...
/datum/reagents/proc/check_ignoreslow(mob/M)
	if(istype(M, /mob))
		if(M.reagents.has_reagent("morphine")||M.reagents.has_reagent("heroin")||M.reagents.has_reagent("bath_salts"))
			return 1
		else
...
/datum/reagents/proc/check_gofast(mob/M)
	if(istype(M, /mob))
		if(M.reagents.has_reagent("unholywater")||M.reagents.has_reagent("nuka_cola")||M.reagents.has_reagent("stimulants")||M.reagents.has_reagent("ephedrine")||M.reagents.has_reagent("crank"))
			return 1
		else
...
/datum/reagents/proc/check_goreallyfast(mob/M)
	if(istype(M, /mob))
		if(M.reagents.has_reagent("methamphetamine")||M.reagents.has_reagent("bath_salts")||M.reagents.has_reagent("changelingAdrenaline2"))
			return 1
		else

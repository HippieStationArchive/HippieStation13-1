...
/obj/item/weapon/restraints/handcuffs/energy/used/dropped(mob/user)
	user.visible_message("<span class='danger'>[user]'s [src] breaks in a discharge of energy!</span>", \
							"<span class='userdanger'>[user]'s [src] breaks in a discharge of energy!</span>")

...
/obj/item/weapon/bookofdarkness/attack_self(mob/living/user)
	user << "<font color=purple>You rapidly skim trough the pages, but you can't see any letters. As you close the book however, you suddenly find equipment at your feet, and your brain hurts.</font color>"
	user << "<font color=purple><b>The Staff of Revenant</b></font color> is a powerful artifact that lets you drain the souls of the fallen by hitting them with a melee strike from your staff. It starts off relatively weak, but can grow to become the largest threat one can ever face. Activate it in your hand to see your progress, the weapon's current stats and to progress to the next stage if possible."
	user << "<font color=purple><b>Soulflare</b></font color> deals 15 burn, brute and toxins damage to the target, putting them asleep for 5 seconds and if they are already in critical condition, they are instantly killed and the spell is refunded. This also applies to corpses."
	user << "<font color=purple><b>Corpse Explosion</b></font color> causes a corpse to violently explode in a very large radius, destroying the body alongside it. Make sure to maintain at least 4 tiles distance between you and the target."
	user << "<font color=purple><b>Soulsplit</b></font color> let's you become incorporeal for 3.5 seconds, allowing you to phase trough objects and walk at very high speeds. However, it cannot be cast if you are below 100 health. In addition, you are still vulnerable to damage and other attacks in this state, nor will it remove any stuns."
	user << "<font color=purple><b>Your robes</b></font color> have increased resistance against all damage and will help convey your peaceful intent towards the still living."

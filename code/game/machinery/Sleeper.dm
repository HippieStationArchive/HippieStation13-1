...
/obj/machinery/sleeper
	...
	var/list/possible_chems = list(list("sleeptoxin", "salbutamol", "bicaridine", "kelotane"),
								   list("sleeptoxin", "salbutamol", "bicaridine", "kelotane", "oculine"),
								   list("sleeptoxin", "salbutamol", "bicaridine", "kelotane", "oculine", "antitoxin", "mutadone", "mannitol", "pen_acid"),
								   list("sleeptoxin", "salbutamol", "bicaridine", "kelotane", "oculine", "antitoxin", "mutadone", "mannitol", "pen_acid", "omnizine"))

...
/obj/machinery/turretid/proc/updateTurrets()
	src.lethal = lethal
	src.check_synth = check_synth
	src.check_access = check_access
	src.check_records = check_records
	src.check_arrest = check_arrest
	src.check_weapons = check_weapons
	src.check_anomalies = check_anomalies
	src.ailock = ailock

	if(control_area)
		for (var/obj/machinery/porta_turret/aTurret in get_area_all_atoms(control_area))
			aTurret.setState(src)
	src.update_icon()

...
var/global/list/datum/species/rewardlistbase = list(/datum/species/human, /datum/species/lizard,/datum/species/cat, /datum/species/bird, /datum/species/bot, /datum/species/skelly, /datum/species/jelly)

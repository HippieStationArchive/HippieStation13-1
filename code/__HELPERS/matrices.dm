...
/atom/proc/SpinAnimation(speed = 10, loops = -1, var/easein, var/easeout)
	...
	animate(src, transform = m120, time = speed, loops, easing = easein)
	animate(transform = m240, time = speed)
	animate(transform = m360, time = speed, easing = easeout)
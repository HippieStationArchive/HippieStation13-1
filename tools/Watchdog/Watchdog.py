...
MONITOR = ('188.165.255.120', 1337)  # IP, port.
RESTART_COMMAND = "/home/byond/ss13.sh"  # What shell script restarts SS13?
COMPILE_COMMAND = "/home/byond/compile_ss13.sh"  # What shell script should be run to compile SS13?
STATS_FILE = 'stats.json'  # Where do you want stats.json placed?

MAX_FAILURES = 3
TIMEOUT = 30.0  # 30 seconds
WAIT_FOR_SERVER_RESPONSE = True  # Wait for server to write ready4update.txt before running COMPILE_COMMAND?

LOGPATH = '/home/byond/crashlogs/'  # Where do you want crash.log stored?
GAMEPATH = '/home/byond/HippieStation13'  # Where is the game directory?
CONFIGPATH = '/home/byond/config/'  # Where is your current list of config files?
